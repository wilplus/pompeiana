...
export const UI = {
  ...
  read_passage: { pl:"Przeczytaj fragment", it:"Leggi il brano", fr:"Lire le passage", es:"Leer el pasaje", de:"Text lesen", la:"Locum legere", ru:"Читать отрывок", uk:"Читати уривок", be:"Чытаць урывак", zh:"閱讀經文" },
  saving: { pl:"Zapisywanie…", it:"Salvataggio…", fr:"Enregistrement…", es:"Guardando…", de:"Speichern…", la:"Servans…", ru:"Сохранение…", uk:"Збереження…", be:"Захаванне…", zh:"儲存中…" },
  save_failed: { pl:"Nie udało się zapisać. Spróbuj ponownie.", it:"Salvataggio non riuscito. Riprova.", fr:"Échec de l'enregistrement. Réessayez.", es:"No se pudo guardar. Inténtalo de nuevo.", de:"Speichern fehlgeschlagen. Versuche es erneut.", la:"Servare defecit. Iterum conare.", ru:"Не удалось сохранить. Попробуйте снова.", uk:"Не вдалося зберегти. Спробуйте ще раз.", be:"Не ўдалося захаваць. Паспрабуйце зноў.", zh:"儲存失敗，請重試。" },
  scripture_shared_note: { pl:"Zapisywane dla wszystkich użytkowników. Wklej tekst z legalnie posiadanej Biblii.", it:"Salvato per tutti gli utenti. Incolla il testo dalla tua Bibbia.", fr:"Enregistré pour tous les utilisateurs. Collez le texte de votre Bible.", es:"Guardado para todos los usuarios. Pega el texto de tu Biblia.", de:"Für alle Nutzer gespeichert. Füge den Text aus deiner Bibel ein.", la:"Pro omnibus usoribus servatur. Textum ex Bibliis tuis insere.", ru:"Сохраняется для всех пользователей. Вставьте текст из вашей Библии.", uk:"Зберігається для всіх користувачів. Вставте текст із вашої Біблії.", be:"Захоўваецца для ўсіх карыстальнікаў. Устаўце тэкст з вашай Бібліі.", zh:"為所有使用者儲存。請貼上你聖經中的經文。" },
};
